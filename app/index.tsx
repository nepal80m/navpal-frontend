...
import VoiceRecording from './voice_recording';
...
export default function Index() {
  ...
  //     const response = await fetch(process.env.BACKEND_HTTP_BASE + '/audio/', {
  //       method: 'POST',
  //       body: formData,
  //       headers: {
  ...
  return (
    <View style={styles.container}>
      {/* Placeholder for Fullscreen Map */}
      ...
      <View style={styles.buttonHolder}>
        ...
        <TouchableOpacity style={styles.micButton} onPress={startSpeaking}>
          {isSpeaking ? (
            <Ionicons name="exit-outline" size={24} color="white" />
          ) : (
